...
/*                    Toast.makeText(ReportActivity.this, "add" + deviceid, Toast.LENGTH_SHORT).show();
                   ...
                   */
                    if (deviceid.equals(currentdeviceid)) {
                        ...
                        Toast.makeText(PrivacyPolicyActivity.this, "You are logged in other device", Toast.LENGTH_SHORT).show();
                ...
                public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                    ...
                    if (!deviceid.equals("data")) {
                        ...
                        if (deviceid.equals(currentdeviceid)) {
                            ...
                            mAuth.signOut();
                            Toast.makeText(PrivacyPolicyActivity.this, "You are logged in other device", Toast.LENGTH_SHORT).show();
                            Intent isend = new Intent(PrivacyPolicyActivity.this, SplashActivity.class);
                ...
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(PrivacyPolicyActivity.this, "" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
